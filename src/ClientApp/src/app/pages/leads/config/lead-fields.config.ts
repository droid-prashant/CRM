...
export function buildLeadFields(options: LeadFieldOptions): DynamicField[] {
    return [
        ...
        { key: 'partnerId', label: 'Partner', type: 'select', options: options.partners, colSpan: 3, section: 'Lead Classification', placeholder: 'Select lead partner' },
        ...
        { key: 'campaignName', label: 'Campaign Name', type: 'text', colSpan: 4, section: 'Additional Details' },
        { key: 'address', label: 'Address', type: 'textarea', colSpan: 4, section: 'Additional Details' },
        { key: 'notes', label: 'Notes', type: 'textarea', colSpan: 4, section: 'Additional Details' }
    ];
}
