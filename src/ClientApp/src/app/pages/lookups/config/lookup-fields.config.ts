...
export const CURRENCY_LOOKUP_ID = 3;

export function buildLookupFields(lookupTypes: SelectOption[], defaultLookupId?: number | null, currencyOptions: SelectOption[] = []): DynamicField[] {
    return [
        ...
        { key: 'defaultCurrencyId', label: 'Currency', type: 'select', options: currencyOptions, colSpan: 6, section: 'Lookup', placeholder: 'Select currency', visibleWhen: (formValue) => Number(formValue['lookupId']) === COUNTRY_LOOKUP_ID },
