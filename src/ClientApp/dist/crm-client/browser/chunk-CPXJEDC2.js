...
var RouterLinkActive = class _RouterLinkActive {
  ...
  set routerLinkActive(data) {
    ...
    this.classes = classes3.filter((c2) => !!c2);
  }
  /** @docs-private */
  ngOnChanges(changes) {
    this.update();
...
var tokenStorageKey = "crm.auth.token";
var userStorageKey = "crm.auth.user";
var AuthService = class _AuthService {
  http;
  router;
  currentUserSignal = signal(this.readUser(), ...ngDevMode ? [{ debugName: "currentUserSignal" }] : []);
  ...
  login(request) {
    return this.http.post(apiUrl("/auth/login"), request).pipe(tap((response) => {
      const user = {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-CPXJEDC2.js.map
