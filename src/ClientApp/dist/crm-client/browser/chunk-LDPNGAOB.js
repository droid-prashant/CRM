...
var Access = class _Access {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Access, selectors: [["app-access"]], decls: 10, vars: 0, consts: [[1, "bg-surface-50", "dark:bg-surface-950", "flex", "items-center", "justify-center", "min-h-screen", "min-w-screen", "overflow-hidden"], [1, "card", "w-full", "max-w-xl", "text-center"], [1, "flex", "justify-center", "items-center", "border-2", "border-orange-500", "rounded-full", "mx-auto", "mb-6", 2, "width", "3.2rem", "height", "3.2rem"], [1, "text-orange-500", "pi", "pi-fw", "pi-lock", "text-2xl!"], [1, "text-surface-900", "dark:text-surface-0", "font-bold", "text-4xl", "mb-3"], [1, "text-muted-color", "mb-8"], ["label", "Go to Dashboard", "routerLink", "/", "severity", "warn"]], template: function Access_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(8, "You do not have permission to view this page.");
      \u0275\u0275elementEnd();
      \u0275\u0275element(9, "p-button", 6);
      \u0275\u0275elementEnd()();
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Access, { className: "Access", filePath: "src/app/pages/auth/access.ts", lineNumber: 22 });
})();
  ...
  submit() {
    ...
    this.authService.login(value).subscribe({
      ...
      error: (error) => {
        ...
        this.messageService.add({ severity: "error", summary: "Sign in failed", detail, life: 5e3 });
      }
    });
  }
  static \u0275fac = function Login_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Login)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(MessageService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Login, selectors: [["app-login"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 22, vars: 6, consts: [["position", "bottom-right"], [1, "min-h-screen", "bg-surface-50", "px-4", "py-8", "dark:bg-surface-950"], [1, "mx-auto", "flex", "min-h-[calc(100vh-4rem)]", "w-full", "max-w-md", "items-center"], [1, "w-full", "rounded-md", "border", "border-surface-200", "bg-surface-0", "p-6", "shadow-sm", "dark:border-surface-800", "dark:bg-surface-900"], [1, "mb-8"], [1, "mb-3", "inline-flex", "h-11", "w-11", "items-center", "justify-center", "rounded-md", "bg-primary", "text-primary-contrast"], [1, "pi", "pi-lock", "text-xl"], [1, "m-0", "text-2xl", "font-semibold", "text-surface-900", "dark:text-surface-0"], [1, "mt-2", "mb-0", "text-surface-600", "dark:text-surface-300"], [1, "flex", "flex-col", "gap-4", 3, "ngSubmit", "formGroup"], ["for", "usernameOrEmail", 1, "mb-2", "block", "text-sm", "font-semibold", "text-surface-700", "dark:text-surface-200"], ["id", "usernameOrEmail", "pInputText", "", "type", "text", "formControlName", "usernameOrEmail", "autocomplete", "username", 1, "w-full"], ["for", "password", 1, "mb-2", "block", "text-sm", "font-semibold", "text-surface-700", "dark:text-surface-200"], ["inputId", "password", "formControlName", "password", "autocomplete", "current-password", 3, "toggleMask", "feedback", "fluid"], ["type", "submit", "label", "Sign In", "icon", "pi pi-sign-in", "styleClass", "w-full", 3, "loading", "disabled"]], template: function Login_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "app-floating-configurator")(1, "p-toast", 0);
      \u0275\u0275elementStart(2, "main", 1)(3, "div", 2)(4, "section", 3)(5, "div", 4)(6, "span", 5);
      \u0275\u0275element(7, "i", 6);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "h1", 7);
      \u0275\u0275text(9, "CRM Sign In");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "p", 8);
      \u0275\u0275text(11, "Use your assigned CRM credentials.");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(19, "Password");
      \u0275\u0275elementEnd();
      \u0275\u0275element(20, "p-password", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275element(21, "p-button", 14);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(12);
      ...
      \u0275\u0275advance(8);
      \u0275\u0275property("toggleMask", true)("feedback", false)("fluid", true);
      \u0275\u0275advance();
      \u0275\u0275property("loading", ctx.isSubmitting)("disabled", ctx.form.invalid || ctx.isSubmitting);
    }
  }, dependencies: [ButtonModule, Button, InputTextModule, InputText, PasswordModule, Password, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, ToastModule, Toast, AppFloatingConfigurator], encapsulation: 2 });
};
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Login, { className: "Login", filePath: "src/app/pages/auth/login.ts", lineNumber: 50 });
})();
...
var Error = class _Error {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Error, selectors: [["app-error"]], decls: 10, vars: 0, consts: [[1, "bg-surface-50", "dark:bg-surface-950", "flex", "items-center", "justify-center", "min-h-screen", "min-w-screen", "overflow-hidden"], [1, "card", "w-full", "max-w-xl", "text-center"], [1, "flex", "justify-center", "items-center", "border-2", "border-pink-500", "rounded-full", "mx-auto", "mb-6", 2, "height", "3.2rem", "width", "3.2rem"], [1, "pi", "pi-fw", "pi-exclamation-circle", "text-2xl!", "text-pink-500"], [1, "text-surface-900", "dark:text-surface-0", "font-bold", "text-4xl", "mb-3"], [1, "text-muted-color", "mb-8"], ["label", "Go to Dashboard", "routerLink", "/", "severity", "danger"]], template: function Error_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "app-floating-configurator");
      \u0275\u0275elementStart(1, "div", 0)(2, "div", 1)(3, "div", 2);
      \u0275\u0275element(4, "i", 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "h1", 4);
      \u0275\u0275text(6, "Something Went Wrong");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p", 5);
      \u0275\u0275text(8, "The requested resource is not available.");
      \u0275\u0275elementEnd();
      \u0275\u0275element(9, "p-button", 6);
      \u0275\u0275elementEnd()();
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Error, { className: "Error", filePath: "src/app/pages/auth/error.ts", lineNumber: 22 });
})();
...
//# sourceMappingURL=chunk-LDPNGAOB.js.map
