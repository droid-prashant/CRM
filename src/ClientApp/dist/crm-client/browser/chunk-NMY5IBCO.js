  ...
  if (p(e)) {
    ...
    if (z2(a2, k3)) {
      let n = a2.replaceAll(k3, (l2) => {
        let c3 = l2.replace(/{|}/g, "").split(".").filter((m2) => !s4.some((d2) => z2(m2, d2)));
        return `var(${ae(r, ee(c3.join("-")))}${s2(i2) ? `, ${i2}` : ""})`;
      });
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    var o, c3;
    let { semantic: i2 } = t2 || {}, a2 = s4 && Object.hasOwn(s4, "light") ? s4.light : s4, n = s4 && Object.hasOwn(s4, "dark") ? s4.dark : s4, l2 = { colorScheme: { light: g2(g2({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: g2(g2({}, (c3 = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c3.dark), !!n && { surface: n }) } };
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let h2 = m2[u], f2 = ve(h2), p2 = z2(u, a2) ? Q(d2) : Q(d2, ee(u));
      if (i(f2)) o.push({ node: f2, path: p2 });
      else {
        let y3 = ae(p2), R3 = Y3(f2, p2, s4, [a2]);
        Re(l2, y3, R3);
        let T3 = p2;
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  let a2 = function(l2, o = {}, c3 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = z2(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m2)}` : oe2(m2), h2 = c3 ? `${c3}.${m2}` : m2;
      i(d2) ? n(d2, u, h2) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x2 = {}, p2 = []) => {
        ...
        if (f2 && f2 !== "none") for (let y3 = 0; y3 < i2[u].paths.length; y3++) {
          ...
          if (R3.scheme === f2) return R3.computed(f2, x2.binding, p2);
        }
  ...
  if (s2(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c3.reduce((m2, { type: d2, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d2, t2)), m2), "") : C2(l2 != null ? l2 : ":root", t2);
    }
    if (o) {
...
var BaseStyle = class _BaseStyle {
  ...
  loadTheme = (options = {}, style7 = "") => {
    return this.load(this.theme, options, (computedStyle = "") => S2.transformCSS(options.name || this.name, `${computedStyle}${ar`${style7}`}`));
  };
...
var environment = {
  ...
  imageUrl: "https://localhost:7094"
};

// src/app/core/http/api-url.ts
var apiPath = "/api";
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-NMY5IBCO.js.map
